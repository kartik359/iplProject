  ...
  return (
    <div className='homeContainer'>
      ...
      {matchData.map((data, index) => {
        console.log(data.matchDetailsMap);
        return (
         <div key={index} className="homemain">
         <Link className= "link" to={`MatchDetail/${data.matchDetailsMap.match[0].matchInfo.matchId}`}>
            <div className="matchno" key={index}>  <p className="desc"> T20 {data.matchDetailsMap.match[0].matchInfo.matchDesc}  </p><p className="date">{data.matchDetailsMap.key}</p></div>
 <div className="score">
  <div className="teams">
   <div className="team1">
<div className="team1left">
<img src={ `https://res.cloudinary.com/digkgdovw/image/upload/v1715267905/iplTeamLogo/${data.matchDetailsMap.match[0].matchInfo.team1.imageId}`} alt="team1" />
<p className="team1sname">{data.matchDetailsMap.match[0].matchInfo.team1.teamSName}</p>
</div>
<div className="team1right">
<p className='team1score'>{data.matchDetailsMap.match[0].matchScore?.team1Score?.inngs1?.runs}/{data.matchDetailsMap.match[0].matchScore?.team1Score?.inngs1?.wickets}  ({data.matchDetailsMap.match[0].matchScore?.team1Score?.inngs1?.overs}/20)</p>
</div>
   </div>
   <div className="team2">
<div className="team2left">
<img src={ `https://res.cloudinary.com/digkgdovw/image/upload/v1715267905/iplTeamLogo/${data.matchDetailsMap.match[0].matchInfo.team2.imageId}`} alt="team1" />
<p className="team2sname">{data.matchDetailsMap.match[0].matchInfo.team2.teamSName}</p>
</div>
<div className="team2right">
<p className='team2score'>{data.matchDetailsMap.match[0].matchScore?.team2Score?.inngs1?.runs}/{data.matchDetailsMap.match[0].matchScore?.team2Score?.inngs1?.wickets}  ({data.matchDetailsMap.match[0].matchScore?.team2Score?.inngs1?.overs}/20)</p>
</div>

   </div>
  </div>
 </div>
            <h6 className="result"><strong>Result : </strong>{data.matchDetailsMap.match[0].matchInfo.status}</h6>
            <p className="city"><strong>city :  </strong>{data.matchDetailsMap.match[0].matchInfo.venueInfo.city} </p>
            <p className="venue"><strong>venue : </strong>  {data.matchDetailsMap.match[0].matchInfo.venueInfo.ground} </p>
        </Link>
